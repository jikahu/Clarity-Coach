...
export default function App() {
  ...
  // Centered, recruiter-friendly layout
      ...
      <div style={card}>
        ...
        <div ref={listRef} style={list}>
          {messages.map((m, i) => {
            ...
            const row: React.CSSProperties = { display: "flex", justifyContent: isUser ? "flex-end" : "flex-start" };
            ...
            return (
              <div key={i} style={row}>
                <div className="msg" style={bubble}>{m.content}</div>
              </div>
            );
          })}
          ...
          {loading && (
            <div style={{ display: "flex", justifyContent: "flex-start" }}>
              <div className="msg" style={{ maxWidth: "58%", padding: "10px 14px", borderRadius: "16px", background: "#ffffff", border: "1px solid #e2e8f0", boxShadow: "0 2px 6px rgba(0,0,0,0.05)", animation: "msgIn 160ms ease-out" }}>
